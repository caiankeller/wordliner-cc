...
<template>
  <button
    class="bg-indigo-500 mt-4 active:scale-[.97] text-white transition-all items-center text-sm font-semibold flex gap-2 px-4 py-2 rounded-full"
  ...
  <teleport to="body">
    <transition name="dialog-fade">
      <div
        v-if="propertyStore.property !== null"
    ...
    <transition name="modal-fade">
      ...
      >
        <form
          ...
          @submit.prevent="propertyStore.saveCurrentProperty()"
        >
          <div class="flex justify-between items-center">
            ...
            <button
              class="text-neutral-600 hover:text-neutral-900 transition-colors p-0.5 rounded-full"
              @click="propertyStore.dismissCurrrentProperty()"
            >
          ...
          <label class="md:col-span-1 col-span-2">
            ...
            <div class="flex-grow flex items-center">
              <input
                id="title"
                v-model="propertyStore.property.title"
                type="text"
                placeholder="title"
                spellcheck="false"
                required
          ...
          <label class="md:col-span-1 col-span-2">
            ...
            <div class="flex-grow flex items-center">
              <input
                id="address"
                v-model="propertyStore.property.address"
                type="text"
                placeholder="address"
                spellcheck="false"
                required
          ...
          <label class="md:col-span-1 col-span-2">
            ...
            <div class="flex-grow flex items-center">
              <textarea
                id="description"
                v-model="propertyStore.property.description"
                type="text"
          ...
          <div class="grid grid-cols-2 gap-4">
            <label class="md:col-span-1 col-span-2">
              ...
              <select
                v-model="propertyStore.property.status"
            ...
            <label class="md:col-span-1 col-span-2">
              <span class="text-neutral-800 text-sm font-medium"
                >Type of Contract</span
              >
              <select
                v-model="propertyStore.property.type_of_contract"
                class="rounded-md w-full py-2 pl-2 text-sm transition-shadow text-neutral-800 border-r-8 border-transparent bg-white overflow-clip outline outline-1 outline-neutral-300 focus:outline-neutral-400"
              >
            ...
            <label class="md:col-span-1 col-span-2">
              ...
              <div class="flex-grow flex items-center">
                <CurrencyInput
                  v-model.lazy="propertyStore.property.price"
            ...
            <label class="md:col-span-1 col-span-2">
              ...
              <div class="flex gap-2 items-center h-[32px]">
                <input
                  v-model="propertyStore.property.hidden"
                  type="checkbox"
                  class="h-4 w-4 accent-indigo-500 bg-gray-100 border-neutral-300 rounded-xl focus:ring-indigo-500 focus:ring-2"
                >
                <span class="text-neutral-800 text-xs font-medium"
                  >Hide from users</span
                >
              </div>
            </label>
          </div>
          <button
            :disabled="propertyStore.fetching"
